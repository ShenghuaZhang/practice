...
/**
 * This class implements a Binary Search Tree for the AddressBook application.
 *
 * @author Justin Goetz
 **/
public class AddressBookBST implements Dictionary {
	...
	/**
	 * Adds the given item to the dictionary. If the item is already in the
	 * dictionary, a <code>DuplicateException</code> is thrown.
	 *
	 * @param item
	 *            the key/data for the item to add to the dictionary
	 ...
	 * 
	 * @param n
	 *            the node to try and insert under
	 * @param item
	 *            the item to insert
	 * @throws duplicate
	 *             exception
	...
	/**
	 * Determines if the given item is in the dictionary and returns it if
	 * present.
	 *
	 * @param item
	 *            the key/data for the item desired
	 ...
	 *
	 * @param item
	 *            the key/data for the item to remove from the dictionary
	...
	/**
	 * Removes the item and returns the correct Binary tree node in order to
	 ...
	 *
	 * @param n
	 *            the root of the tree to check for
	...
	/**
	 * Prints all the key/data items in the specified range in sorted order from
	 * smallest to largest to the PrintWriter given. When an item is printed the
	 * key/data is output by converting it to a String.
	 * 
	 * @param begin
	 *            the minimum key/data value. Only items in the ordered list
	 *            that are greater than or equal to begin (according to the
	 *            compareTo method) will be printed.
	 * @param end
	 *            the maximum key/data value. Only items in the ordered list
	 *            that are less than or equal to end (according to the compareTo
	 *            method) will be printed.
	 * @param p
	 *            the PrintWriter to which to send the output
	 **/
	 ...
	 *
	 * @param n
	 *            the root of the tree to try and print from
	 * @param begin
	 *            the beginning key to print from
	 * @param end
	 *            the ending key to print from
	 * @param p
...
class BSTNode {
	 ...
	 *            the node's key
	 * @param l
	 *            the nodes left child pointer
	 * @param r
	 *            the nodes right child pointer
	 **/
