...
public class Fibonacci {
	...
	public static void main(String[] args) {
		// Handle arguments
//		if (args.length != 1) {
//			System.err.println("Usage: java fast fibonacci N");
//			System.exit(1);
//			return;
//		}
//		int n = Integer.parseInt(args[0]);
		...
		System.out.printf("Fast doubling: %d ms%n",
				(System.nanoTime() - startTime) / 1000000);

		startTime = System.nanoTime();
		BigInteger y = fastFibonacciMatrix(n);
		System.out.printf("Fast matrix: %d ms%n",
				(System.nanoTime() - startTime) / 1000000);

		startTime = System.nanoTime();
		BigInteger z = slowFibonacci(n);
		System.out.printf("Slow DP: %d ms%n",
				(System.nanoTime() - startTime) / 1000000);
	 ...
	 * This implementation is the non-recursive version. See the web page and the other programming
	 * language implementations for the recursive version.
	 */
	...
	/*
	 * Fast matrix method. Easy to describe, but has a constant factor slow down
	 * compared to doubling method. [1 1]^n [F(n+1) F(n) ] [1 0] = [F(n)
	 * F(n-1)].
	 */
