...
public class PathSum {
	...
	/*
	 * I should pay more attention on the mark 0 and 1.
	 * Which remind me that I need be careful.
	 */
	...
	public static void main(String[] args) {
		...
		System.out.print(hasPathSum(root, 8) ? pathSum(root, 8)
				: "Do not has this path.");
	}
}
